...
## Referências de direção para o comercial

As referências pesquisadas apontam para três princípios que serão traduzidos em uma peça original: a viagem deve comunicar liberdade e aventura sem depender de texto longo; a moto precisa aparecer em planos de presença — silhueta, detalhe mecânico, roda e deslocamento — e não apenas como fundo; e o ritmo deve alternar planos de estrada com respiros de produto. A referência editorial da RideApart descreve comerciais de motocicleta como narrativas de liberdade, aventura, amizade e atitude, enquanto a página de iSpot sobre um comercial em estrada reforça a força de uma progressão visual por uma estrada sinuosa. O vídeo do YouTube pesquisado estava indisponível, portanto não foi usado como fonte factual.

Referências consultadas: [RideApart — The Dream Rangers](https://www.rideapart.com/news/247673/a-feel-good-motorcycle-video-commercial-the-dream-rangers/), [iSpot — Rainier Beer TV Spot, Motorcycle](https://www.ispot.tv/ad/wt1l/rainier-beer-motorcycle), [YouTube — Motorcycle Cinematic Short Film, indisponível](https://www.youtube.com/watch?v=laZ-m8y9YM).

A página oficial da [SHI 250 na Shineray Brasil](https://www.shineray.com.br/produto/shi-250/) confirma o produto real, preço exibido pela marca, atributos de aventura dentro e fora da cidade, rodas raiadas, freios a disco, painel digital, suspensão invertida e galeria oficial. O canal público consultado em `youtube.com/@ShinerayMotos` retornou 404 na sessão, portanto não será usado como mídia remota sem confirmação adicional. A solução audiovisual deve ser uma peça original da Neto Motos, com referência de linguagem e sem reaproveitar vídeos de terceiros.

A tentativa de gerar o clipe comercial foi bloqueada pelo limite diário do plano gratuito. Para não deixar a capa parada, foi implementado um fallback original com três fotos oficiais da SHI 250 em crossfade, dolly, estrada em grid 3D, feixe vermelho, textura de papel e suporte a `prefers-reduced-motion`. O clipe final continua pendente até a quota resetar ou até receber um vídeo autorizado do usuário.

O [Google Flow](https://labs.google/fx/tools/flow) confirma a proposta de transformar imagens em vídeos de alta fidelidade com Veo, mas a página expõe um fluxo interativo de criação (“Try in Google Flow”) e planos/assinaturas. Não há um caminho público, automatizável e autorizado nesta sessão para eu enviar a foto da SHI 250, gerar o MP4 e baixar o resultado sem intervenção do usuário. A solução imediata permanece o fallback cinematográfico já integrado; a rota Flow pode ser concluída manualmente pelo usuário com a imagem oficial e o roteiro preparado.

Na página de preços consultada, o Flow anuncia uma modalidade sem assinatura com conta Google e créditos diários, incluindo texto para vídeo, frames para vídeo, ingredients-to-video e edição video-to-video. Os botões “Try in Google Flow” permaneceram na página de apresentação durante a sessão, sem abrir um workspace de criação autenticado; por isso não foi possível fazer upload da referência nem concluir a geração remotamente.
