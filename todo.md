...
- [x] Planejar uma capa com motion cinematográfico leve, respeitando performance e acessibilidade.
- [x] Reescrever a virada para simular dobra, sombra, curvatura e arrasto de uma folha real.
- [x] Refinar ícones, hierarquia tipográfica e espaçamento da página principal.
- [x] Validar o novo fluxo em desktop e mobile com prefers-reduced-motion.

- [x] Mapear todas as motocicletas oficiais da linha atual no site da Shineray Brasil.
- [x] Separar motocicletas, scooters, elétricas e veículos que não pertencem ao escopo de motos.
- [x] Confirmar URLs oficiais de produto e imagens reais por modelo.
- [x] Expandir o banco local de motos com dados verificáveis e avisos de validação comercial.
- [x] Reescrever headlines, descrições, argumentos e CTAs com copywriting de alta conversão.
- [x] Adicionar arquitetura de prova, objeções, comparação e próximo passo para WhatsApp.
- [x] Implementar atmosfera 3D animada com parallax, camadas de luz e profundidade controlada.
...
- [x] Reconstruir a versão portátil, sincronizar o bundle nas branches públicas e registrar que o GitHub Pages externo não iniciou a implantação automática.
...
- [x] Reconstruir a distribuição, publicar os arquivos estáticos nas branches e disponibilizar uma alternativa portátil completa diante do bloqueio externo do Pages.
- [x] Preparar a versão final para checkpoint, com implementação, validação e entrega portátil concluídas.

## Entrega portátil para download
